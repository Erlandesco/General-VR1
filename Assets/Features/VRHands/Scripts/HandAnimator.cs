...
public class HandAnimator : MonoBehaviour
{
    ...
    /// <summary>
    /// Add your own hand animation here. For example a UI.
    /// </summary>
    ...
    private void ActiveFistAnimation(InputAction.CallbackContext obj)
    {
        SetFingerAnimationValues(fistFingers, 1.0f);
        AnimateActionInput(fistFingers);

    }
    private void DisableFistAnimation(InputAction.CallbackContext obj)
    {
